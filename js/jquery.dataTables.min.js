...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Tidak ada data."===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Selanjutnya",sPrevious:"Sebelumnya"},sEmptyTable:"Tidak ada data.",sInfo:"Menampilkan _START_ - _END_ dari _TOTAL_ entri",sInfoEmpty:"Menampilkan 0 - 0 dari 0 entri",sInfoFiltered:"(Disaring dari _MAX_ entri)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Menampilkan _MENU_ entri",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Cari:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Tidak ada yang cocok"},
